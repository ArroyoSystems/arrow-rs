...
impl DecoderContext {
    ...
    fn make_field_decoder(
        ...
        {
            return Ok(Box::new(JsonArrayDecoder::new()));
        }
...
mod tests {
    ...
    fn test_deserialize_raw_json_edge_cases() {
        fn assert_case(value_src: &str) {
            ...
            let schema = Arc::new(Schema::new(vec![
                Field::new("value", DataType::Utf8, false).with_metadata(meta),
            ]));
    ...
    fn test_missing_non_nullable_raw_json_is_invalid() {
        ...
        let schema = Arc::new(Schema::new(vec![
            Field::new("required", DataType::Utf8, false).with_metadata(metadata),
        ]));
